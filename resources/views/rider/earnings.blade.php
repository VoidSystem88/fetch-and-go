    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-lg shadow">
            ...
            <div class="p-6">
                ...
                <div class="mb-8">
                    <h3 class="text-lg font-semibold text-gray-800 mb-3">📈 Daily Earnings (Last 7 Days)</h3>
                    <div class="bg-white p-4 rounded-lg border">
                        <canvas id="dailyEarningsChart" height="300"></canvas>
                    </div>
                </div>

                <!-- Monthly Earnings Chart -->
                <div class="mb-8">
                    <h3 class="text-lg font-semibold text-gray-800 mb-3">📊 Monthly Earnings (Last 6 Months)</h3>
                    <div class="bg-white p-4 rounded-lg border">
                        ...
                        <table class="min-w-full bg-white border rounded-lg">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-500">Deliveries</th>
...
new Chart(monthlyCtx, {
    ...
    data: {
        ...
        datasets: [
            ...
            {
                label: 'Rider Earnings',
                data: @json($monthlyRiderEarnings),
                borderColor: '#10b981',
            ...
            {
                label: 'Platform Fee',
                data: @json($monthlyAdminEarnings),
                borderColor: '#3b82f6',
